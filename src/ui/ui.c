...
void ui_update_watchfaces(int second, int minute, int hour, bool mode, bool am,
                          int day, int month, int year, int weekday, int temp,
                          int icon, int battery, bool connection, int steps,
                          int distance, int kcal, int bpm, int oxygen);
void addListDrive(const char *name, int total, int used,
...
const lv_img_dsc_t *qrIcons[] = {
    &ui_img_chrns_png,      &ui_img_wechat_png,    &ui_img_facebook_png,
    &ui_img_penguin_png,    &ui_img_twitter_x_png, &ui_img_whatsapp_png,
...
const lv_img_dsc_t *weatherIcons[] = {
    &ui_img_602206286, &ui_img_602205261, &ui_img_602199888, &ui_img_602207311,
    &ui_img_dy4_png,   &ui_img_602200913, &ui_img_602195540, &ui_img_602202963};
...
const char *qrNames[9] = {"Chronos",    "Wechat",      "Facebook",
                          "QQ",         "X (Twitter)", "Whatsapp",
...
void pulseCall_Animation(lv_obj_t *TargetObject, int delay) {
  ...
  lv_anim_set_custom_exec_cb(&PropertyAnimation_0,
                             _ui_anim_callback_set_image_zoom);
  ...
  lv_anim_set_get_value_cb(&PropertyAnimation_0,
                           &_ui_anim_callback_get_image_zoom);
...
void ui_event_clockScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    _ui_screen_change(ui_notificationScreen, LV_SCR_LOAD_ANIM_OVER_RIGHT, 500,
                      0);
  }
  if (event_code == LV_EVENT_GESTURE &&
...
void ui_event_weatherScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    if (toAppList) {
      ...
      _ui_screen_change(ui_home, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 500,
                        0); // load home
    }
  }
  if (event_code == LV_EVENT_GESTURE &&
    ...
    _ui_flag_modify(ui_forecastPanel, LV_OBJ_FLAG_HIDDEN,
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    if (!lv_obj_has_flag(ui_weatherPanel, LV_OBJ_FLAG_HIDDEN)) {
      if (toAppList) {
        _ui_screen_change(ui_appListScreen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 500,
                          0);
        return;
      }
    }
    _ui_flag_modify(ui_weatherPanel, LV_OBJ_FLAG_HIDDEN,
                    _UI_MODIFY_FLAG_REMOVE);
...
void ui_event_notificationScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    if (lv_obj_has_flag(ui_messageList, LV_OBJ_FLAG_HIDDEN)) {
      _ui_flag_modify(ui_messageList, LV_OBJ_FLAG_HIDDEN,
                      _UI_MODIFY_FLAG_REMOVE);
...
void ui_event_controlScreen(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
    ...
    _ui_state_modify(ui_phoneSearchButton, LV_STATE_CHECKED,
                     _UI_MODIFY_STATE_ADD);

    onEndSearch(e);
  }
  if (event_code == LV_EVENT_SCREEN_UNLOAD_START) {
    _ui_state_modify(ui_findButtonText, LV_STATE_CHECKED,
...
void onAppListClicked(lv_event_t *e) {
  ...
  case 0:
    ...
    _ui_screen_change(ui_notificationScreen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500,
                      0);
    break;
  case 1:
    toAppList = true; // flag was open from app list
...
void watchfaceEvents(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_GESTURE &&
      lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
    toAppList = false; // flag was not open from app list
    lv_scr_load_anim(ui_notificationScreen, LV_SCR_LOAD_ANIM_OVER_RIGHT, 500, 0,
                     false);
  }
  if (event_code == LV_EVENT_GESTURE &&
      lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
    lv_scr_load_anim(ui_appListScreen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500, 0,
                     false);
  }
  if (event_code == LV_EVENT_GESTURE &&
      lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_BOTTOM) {
    lv_scr_load_anim(ui_controlScreen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 500, 0,
                     false);
  }
  if (event_code == LV_EVENT_GESTURE &&
      lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP) {
    toAppList = false; // flag was not open from app list
    lv_scr_load_anim(ui_weatherScreen, LV_SCR_LOAD_ANIM_MOVE_TOP, 500, 0,
                     false);
  }
...
void onFaceEvent(lv_event_t *e) { watchfaceEvents(e); }
...
void ui_event_gameSelected(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_CLICKED) {
    ...
    lv_scr_load_anim(*games[index].watchface, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500,
                     0, false);
    // lv_scr_load_anim(ui_raceScreen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 500, 0,
    // false);
  }
}
...
void setWeatherIcon(lv_obj_t *obj, int id, bool day) {
  lv_img_set_src(obj, day ? weatherIcons[getWeatherIconIndex(id)]
                          : weatherNtIcons[getWeatherIconIndex(id)]);
}
...
void add_appList(const char *appName, int index, const void *img) {
  ...
  lv_obj_set_style_bg_color(ui_appListPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appListPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_appListPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_appListPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appListPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_appListPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appListPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appListPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appListPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appListPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_appListLabel, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_appListPanel, onAppListClicked, LV_EVENT_CLICKED,
                      (void *)index);
}
...
void add_gameList(const char *appName, int index, const void *img) {
  ...
  lv_obj_set_style_bg_color(ui_gameListPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_gameListPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_gameListPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_gameListPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_gameListPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_gameListPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_gameListPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_gameListPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_gameListPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_gameListPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_gameListLabel, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_gameListPanel, ui_event_gameSelected, LV_EVENT_CLICKED,
                      (void *)index);
}
...
void addWatchface(const char *name, const lv_img_dsc_t *src, int index) {
  ...
  lv_obj_set_style_bg_color(ui_faceItem, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_faceItem, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_faceItem, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_outline_color(ui_faceItem, lv_color_hex(0x142ABC),
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_outline_opa(ui_faceItem, 255,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_outline_width(ui_faceItem, 2,
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_faceLabel, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_faceLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_faceItem, ui_event_faceSelected, LV_EVENT_ALL,
                      (void *)index);
}
...
void addForecast(int day, int temp, int icon) {
  ...
  lv_obj_set_style_bg_color(forecastItem, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(forecastItem, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(forecastItem, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(forecastItem, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(forecastItem, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(forecastItem, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(forecastItem, 10,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(forecastDay, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
}
...
void addNotificationList(int appId, const char *message, int index) {
  ...
  lv_obj_set_flex_align(notificationItem, LV_FLEX_ALIGN_START,
  ...
  lv_obj_set_style_bg_color(notificationItem, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(notificationItem, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(notificationItem, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(notificationItem, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(notificationItem, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(notificationItem, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(notificationItem, 5,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(notificationItem, 5,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(notificationItem, 5,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(notificationItem, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(notificationItem, ui_event_messageClick, LV_EVENT_CLICKED,
                      (void *)index);
}
...
void addQrList(uint8_t id, const char *link) {
  ...
  lv_obj_set_flex_align(ui_qrItem, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER,
  ...
  lv_obj_set_style_bg_color(ui_qrItem, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  ui_qrImage = lv_qrcode_create(ui_qrItem, 150, lv_color_hex(0x000000),
  ...
  lv_obj_set_style_bg_color(ui_qrImage, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_qrLabel, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
}
...
void addAppInfo(const void *src, const char *txt) {
  ...
  lv_obj_set_style_radius(ui_appDetailsPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_appDetailsPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appDetailsPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_appDetailsPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_appDetailsPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appDetailsPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_appDetailsPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appDetailsPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appDetailsPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appDetailsPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appDetailsPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_appDetailsText, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
}
...
void addListDrive(const char *name, int total, int used,
  ...
  lv_obj_set_style_radius(ui_driveInfoPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_driveInfoPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_driveInfoPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_driveInfoPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_driveInfoPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_driveInfoPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_driveInfoPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_color(ui_driveInfoPanel, lv_color_hex(0xFFFFFF),
  // LV_PART_MAIN | LV_STATE_PRESSED);
  // lv_obj_set_style_bg_opa(ui_driveInfoPanel, 100, LV_PART_MAIN |
  // LV_STATE_PRESSED);
  ...
  if (total >= 1048576) {
    lv_label_set_text_fmt(ui_driveInfoLabel, "%s - %dMB", name,
                          (total / 1048576));
  } else if (total >= 1024) {
  ...
  lv_obj_set_style_text_font(ui_driveInfoLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void addListDir(const char *name) {
  ...
  lv_obj_set_style_radius(ui_folderInfoPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_folderInfoPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_folderInfoPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_folderInfoPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_folderInfoPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_folderInfoPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_folderInfoPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_color(ui_folderInfoPanel, lv_color_hex(0xFFFFFF),
  // LV_PART_MAIN | LV_STATE_PRESSED);
  // lv_obj_set_style_bg_opa(ui_folderInfoPanel, 100, LV_PART_MAIN |
  // LV_STATE_PRESSED);
  ...
  lv_obj_set_style_text_font(ui_folderInfoName, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void addListFile(const char *name, int size) {
  ...
  lv_obj_set_style_bg_color(ui_fileInfoPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_fileInfoPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_fileInfoPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_fileInfoPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_fileInfoPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_fileInfoPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_color(ui_fileInfoPanel, lv_color_hex(0xFFFFFF),
  // LV_PART_MAIN | LV_STATE_PRESSED); lv_obj_set_style_bg_opa(ui_fileInfoPanel,
  ...
  lv_obj_set_style_text_font(ui_fileInfoName, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_fileInfoSize, LV_TEXT_ALIGN_RIGHT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_fileInfoSize, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
}
...
void addListBack(lv_event_cb_t event_cb) {
  ...
  lv_obj_set_style_radius(ui_driveBackPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_driveBackPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_driveBackPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_driveBackPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_driveBackPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_driveBackPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_driveBackPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_color(ui_driveBackPanel, lv_color_hex(0xFFFFFF),
  // LV_PART_MAIN | LV_STATE_PRESSED);
  // lv_obj_set_style_bg_opa(ui_driveBackPanel, 100, LV_PART_MAIN |
  // LV_STATE_PRESSED);
  ...
  lv_obj_set_style_text_font(ui_driveBackLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void registerGame_cb(const char *name, const lv_img_dsc_t *icon,
                     lv_obj_t **game) {
...
void init_face_select() {
  ...
  lv_obj_set_flex_align(ui_faceSelect, LV_FLEX_ALIGN_START,
...
void ui_clockScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_clockScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_clockScreen, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_radius(ui_clockScreen, 120, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_bg_img_src(ui_clockScreen,
  // &ui_img_753022056, LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_outline_color(ui_clockScreen, lv_color_hex(0x000000),
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_outline_opa(ui_clockScreen, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_outline_width(ui_clockScreen, 55,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_outline_pad(ui_clockScreen, 0, LV_PART_MAIN |
  // LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_hourLabel, LV_TEXT_ALIGN_RIGHT,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_hourLabel, &ui_font_Number_big,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_minuteLabel, &ui_font_Number_big,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_dateLabel, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_weatherTemp, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_dayLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_amPmLabel, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_clear_flag(ui_alertPanel, LV_OBJ_FLAG_GESTURE_BUBBLE |
                                       LV_OBJ_FLAG_SCROLLABLE); /// Flags
  lv_obj_set_style_bg_color(ui_alertPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_alertPanel, 240, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_alertPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_alertPanel, 240,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_alertPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(ui_alertPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_alertText, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_weatherScreen_screen_init(void) {
  ...
  // lv_obj_set_style_radius(ui_weatherScreen, 120, LV_PART_MAIN |
  // LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_weatherScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_weatherScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_img_src(ui_weatherScreen, &ui_img_857483832,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_img_opa(ui_weatherScreen, 150, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_outline_color(ui_weatherScreen,
  // lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_outline_opa(ui_weatherScreen, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_outline_width(ui_weatherScreen, 55,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_outline_pad(ui_weatherScreen, 0, LV_PART_MAIN |
  // LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_weatherPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_weatherPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_weatherPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_weatherCity, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_weatherCurrentTemp, &lv_font_montserrat_46,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_weatherUpdateTime, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  // lv_obj_set_style_radius(ui_forecastPanel, 120, LV_PART_MAIN |
  // LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_forecastPanel, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_forecastPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_forecastPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_forecastTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_forecastTitle, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_forecastTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_forecastTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_forecastTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_forecastTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_forecastTitle, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_forecastTitle, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_forecastTitle, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_forecastTitle, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_forecastList, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_forecastList, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_forecastList, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_forecastList, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_forecastList, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_forecastList, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_forecastList, 10,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_forecastList, 50,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_label_set_text(info, "Weather information has not yet been synced. "
                          "Connect the device to Chronos app to get weather "
                          "info. Make sure to enable it in the app settings.");

  lv_obj_add_event_cb(ui_weatherScreen, ui_event_weatherScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_appListScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_appListScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appListScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_appList, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_appList, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_appListScreen, ui_event_appListScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_gameListScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_gameListScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_gameListScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_gameList, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_gameList, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_gameList, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_gameList, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_gameListScreen, ui_event_gameListScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_notificationScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_notificationScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_notificationScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_messagePanel, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_messagePanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_messagePanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_messagePanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_messagePanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_messagePanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_messagePanel, 20,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_messagePanel, 70,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_messageList, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
...
void ui_settingsScreen_screen_init(void) {
  ...
  lv_obj_set_style_radius(ui_settingsScreen, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_settingsList, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_settingsList, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_settingsList, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_settingsList, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_settingsList, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_settingsList, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_settingsList, 50,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_settingsList, 70,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_settingsTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_settingsTitle, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_settingsTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_settingsTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_settingsTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_settingsTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_settingsTitle, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_settingsTitle, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_settingsTitle, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_settingsTitle, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_radius(ui_brightnessPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_brightnessPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_brightnessPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_brightnessPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_brightnessPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_brightnessPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_brightnessPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_brightnessPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_brightnessPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_brightnessPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_brightnessPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_radius(ui_scrollingPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_scrollingPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_scrollingPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_scrollingPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_scrollingPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_scrollingPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_scrollingPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_scrollingPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_scrollingPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_scrollingPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_scrollingPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_timeoutPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_timeoutPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_timeoutPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_timeoutPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_timeoutPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_timeoutPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_timeoutPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_timeoutPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_timeoutPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_timeoutPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_timeoutSelect, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_timeoutSelect, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_timeoutSelect, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_timeoutSelect, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_timeoutSelect, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_set_style_bg_color(lv_dropdown_get_list(ui_timeoutSelect),
                            lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(lv_dropdown_get_list(ui_timeoutSelect), 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  // lv_obj_set_style_radius(ui_languagePanel, 0, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_bg_color(ui_languagePanel,
  // lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_opa(ui_languagePanel, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_border_color(ui_languagePanel,
  // lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_border_opa(ui_languagePanel, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_border_width(ui_languagePanel, 1,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_border_side(ui_languagePanel, LV_BORDER_SIDE_BOTTOM,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_pad_left(ui_languagePanel, 0, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_pad_right(ui_languagePanel, 0,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_pad_top(ui_languagePanel, 0, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_pad_bottom(ui_languagePanel, 5,
  // LV_PART_MAIN | LV_STATE_DEFAULT);

  // ui_languageSelect = lv_dropdown_create(ui_languagePanel);
  // lv_dropdown_set_options(ui_languageSelect,
  // "中文\nEnglish\nItaliano\nEspañol\nPortuguês\nрусский\n日本人\n中文\nDeutsche\nไทย");
  ...
  // lv_obj_set_style_bg_color(ui_languageSelect, lv_color_hex(0x000000),
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_opa(ui_languageSelect, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_border_color(ui_languageSelect,
  // lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_border_opa(ui_languageSelect, 255, LV_PART_MAIN |
  // LV_STATE_DEFAULT); lv_obj_set_style_border_width(ui_languageSelect, 1,
  // LV_PART_MAIN | LV_STATE_DEFAULT);

  // lv_obj_set_style_bg_color(lv_dropdown_get_list(ui_languageSelect),
  // lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
  // lv_obj_set_style_bg_opa(lv_dropdown_get_list(ui_languageSelect), 255,
  // LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_radius(ui_alertStatePanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_alertStatePanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_alertStatePanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_alertStatePanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_alertStatePanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_alertStatePanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_alertStatePanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_alertStatePanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_alertStatePanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_alertStatePanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_alertStatePanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_batteryPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_batteryPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_batteryPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_batteryPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_batteryPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_batteryPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_batteryPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_batteryPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_batteryPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_batteryPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_batterySlider, lv_color_hex(0xFFFFFF),
  ...
  lv_obj_set_style_bg_color(ui_aboutPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_aboutPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_aboutPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_aboutPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_aboutPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_aboutPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(ui_aboutPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_kenyaPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_kenyaPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_kenyaPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_kenyaPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_kenyaPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_kenyaPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(ui_kenyaPanel, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_label_set_text(ui_kenyaText,
                    "Made with #f54278 love#\nin Kenya\nusing LVGL");
  ...
  lv_obj_add_event_cb(ui_brightnessSlider, ui_event_brightnessSlider,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_Switch2, ui_event_scrollMode, LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_alertStateSwitch, ui_event_alertStateSwitch,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_timeoutSelect, ui_event_timeoutSelect, LV_EVENT_ALL,
                      NULL);
  // lv_obj_add_event_cb(ui_languageSelect, ui_event_languageSelect,
  // LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_batterySlider, ui_event_batterySlider, LV_EVENT_ALL,
                      NULL);
  lv_obj_add_event_cb(ui_settingsScreen, ui_event_settingsScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_controlScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_controlScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_controlScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_flag(ui_musicPlayButton,
  ...
  lv_obj_set_style_radius(ui_musicPlayButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_musicPlayButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_musicPlayButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_musicPrevButton,
                  LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_musicPrevButton, LV_OBJ_FLAG_SCROLLABLE);    /// Flags
  lv_img_set_zoom(ui_musicPrevButton, 200);
  lv_obj_set_style_radius(ui_musicPrevButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_musicPrevButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_musicPrevButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_musicNextButton,
                  LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_musicNextButton, LV_OBJ_FLAG_SCROLLABLE);    /// Flags
  lv_img_set_zoom(ui_musicNextButton, 200);
  lv_obj_set_style_radius(ui_musicNextButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_musicNextButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_musicNextButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_btStateButton,
                  LV_OBJ_FLAG_CHECKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_btStateButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
  lv_img_set_zoom(ui_btStateButton, 200);
  lv_obj_set_style_img_recolor(ui_btStateButton, lv_color_hex(0x000000),
                               LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_img_recolor_opa(ui_btStateButton, 230,
                                   LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_radius(ui_btStateButton, 5, LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_btStateButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_btStateButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_set_style_bg_color(ui_searchPanel, lv_color_hex(0xFF6910),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_searchPanel, 100, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_searchPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_flag(ui_phoneSearchButton, LV_OBJ_FLAG_CLICKABLE |
                                            LV_OBJ_FLAG_CHECKABLE |
                                            LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_phoneSearchButton, LV_OBJ_FLAG_GESTURE_BUBBLE |
                                              LV_OBJ_FLAG_SCROLLABLE); /// Flags
  lv_img_set_zoom(ui_phoneSearchButton, 200);
  lv_obj_set_style_img_recolor(ui_phoneSearchButton, lv_color_hex(0x000000),
                               LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_img_recolor_opa(ui_phoneSearchButton, 230,
                                   LV_PART_MAIN | LV_STATE_CHECKED);
  lv_obj_set_style_radius(ui_phoneSearchButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_phoneSearchButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_phoneSearchButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_volumeUpButton,
                  LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_volumeUpButton, LV_OBJ_FLAG_SCROLLABLE);     /// Flags
  lv_img_set_zoom(ui_volumeUpButton, 200);
  lv_obj_set_style_radius(ui_volumeUpButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_volumeUpButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_volumeUpButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_volumeDownButton,
                  LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  lv_obj_clear_flag(ui_volumeDownButton, LV_OBJ_FLAG_SCROLLABLE);   /// Flags
  lv_img_set_zoom(ui_volumeDownButton, 200);
  lv_obj_set_style_radius(ui_volumeDownButton, 5,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_color(ui_volumeDownButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_volumeDownButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);
  ...
  lv_obj_add_flag(ui_qrCodeButton,
                  LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
  ...
  lv_obj_set_style_bg_color(ui_qrCodeButton, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_PRESSED);
  lv_obj_set_style_bg_opa(ui_qrCodeButton, 255,
                          LV_PART_MAIN | LV_STATE_PRESSED);

  lv_obj_add_event_cb(ui_musicPlayButton, ui_event_musicPlayButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_musicPrevButton, ui_event_musicPrevButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_musicNextButton, ui_event_musicNextButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_phoneSearchButton, ui_event_phoneSearchButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_volumeUpButton, ui_event_volumeUpButton, LV_EVENT_ALL,
                      NULL);
  lv_obj_add_event_cb(ui_volumeDownButton, ui_event_volumeDownButton,
                      LV_EVENT_ALL, NULL);
  lv_obj_add_event_cb(ui_qrCodeButton, ui_event_qrCodeButton, LV_EVENT_ALL,
                      NULL);
  lv_obj_add_event_cb(ui_controlScreen, ui_event_controlScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_appInfoScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_appInfoScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appInfoScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_flex_align(ui_appInfoPanel, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(ui_appInfoPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appInfoPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appInfoPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appInfoPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appInfoPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appInfoPanel, 25,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appInfoPanel, 50,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_row(ui_appInfoPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_column(ui_appInfoPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_appInfoTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_appInfoTitle, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_appInfoTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_appInfoTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appInfoTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_appInfoTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appInfoTitle, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appInfoTitle, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appInfoTitle, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appInfoTitle, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_radius(ui_appConnectionPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_appConnectionPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appConnectionPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_appConnectionPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_appConnectionPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appConnectionPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_appConnectionPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appConnectionPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appConnectionPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appConnectionPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appConnectionPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_appConnectionText, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_radius(ui_appBatteryPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_appBatteryPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_appBatteryPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_appBatteryPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_appBatteryPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_appBatteryPanel, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_appBatteryPanel, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_appBatteryPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_appBatteryPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_appBatteryPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_appBatteryPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_appBatteryText, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_appInfoScreen, ui_event_appInfoScreen, LV_EVENT_ALL,
                      NULL);
}
...
void ui_callScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_callScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_callLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_callName, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_callName, &lv_font_montserrat_18,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_cameraScreen_screen_init() {
  ...
  lv_obj_clear_flag(ui_cameraPanel, LV_OBJ_FLAG_GESTURE_BUBBLE |
                                        LV_OBJ_FLAG_SCROLLABLE); /// Flags
  lv_obj_set_style_bg_color(ui_cameraPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_cameraPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_cameraPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_cameraPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_cameraPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_cameraPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_cameraPanel, 10,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_cameraTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_cameraTitle, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_cameraTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_cameraTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_cameraTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_cameraTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_cameraTitle, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_cameraTitle, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_cameraTitle, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_cameraTitle, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_cameraLabel, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_cameraButton, ui_event_captureClick, LV_EVENT_CLICKED,
                      NULL);
...
void ui_qrScreen_screen_init(void) {
  ...
  lv_obj_set_flex_align(ui_qrPanel, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_START);
  ...
  lv_obj_set_style_bg_color(ui_qrPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  addQrList(2,
            "https://play.google.com/store/apps/details?id=com.fbiego.chronos");
...
void ui_findPhone_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_findPhoneScreen, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_findPhoneScreen, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_findTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_findTitle, &lv_font_montserrat_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_findTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_findTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_findTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_findTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_flag(ui_findButton, LV_OBJ_FLAG_CHECKABLE |
  ...
  lv_obj_set_style_text_font(ui_findButtonText, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_bg_color(ui_findPanel, lv_color_hex(0xFF6910),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_findPanel, 100, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_findPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_add_event_cb(ui_findPhoneScreen, ui_event_findPhone, LV_EVENT_ALL,
                      NULL);
}
...
void ui_logoScreen_screen_init(void) {
  ...
  lv_obj_set_style_bg_color(ui_logoScreen, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_filesScreen_screen_init(void) {
  ...
  lv_obj_set_flex_align(ui_fileManagerPanel, LV_FLEX_ALIGN_START,
  ...
  lv_obj_set_style_radius(ui_fileManagerPanel, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(ui_fileManagerPanel, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_fileManagerPanel, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_fileManagerPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(ui_fileManagerPanel, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(ui_fileManagerPanel, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(ui_fileManagerPanel, 40,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(ui_fileManagerPanel, 40,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_row(ui_fileManagerPanel, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_column(ui_fileManagerPanel, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_add_event_cb(ui_fileManagerPanel, onScroll, LV_EVENT_SCROLL, NULL);
  lv_obj_add_event_cb(ui_filesScreen, ui_event_appInfoScreen, LV_EVENT_ALL,
                      NULL);
}

void ui_watchfaces_init(void) {
  numFaces = 0;
  registerWatchface_cb("Default", &digital_preview,
                       &ui_clockScreen); // register the default watchface

  // register other watchfaces by initializing them and passing the register
  // callback
...
void ui_update_watchfaces(int second, int minute, int hour, bool mode, bool am,
  ...
  update_check_34_2_dial(ui_home, second, minute, hour, mode, am, day, month,
                         year, weekday, temp, icon, battery, connection, steps,
                         distance, kcal, bpm, oxygen);
  update_check_75_2_dial(ui_home, second, minute, hour, mode, am, day, month,
                         year, weekday, temp, icon, battery, connection, steps,
                         distance, kcal, bpm, oxygen);
  update_check_79_2_dial(ui_home, second, minute, hour, mode, am, day, month,
                         year, weekday, temp, icon, battery, connection, steps,
                         distance, kcal, bpm, oxygen);
  update_check_116_2_dial(ui_home, second, minute, hour, mode, am, day, month,
                          year, weekday, temp, icon, battery, connection, steps,
                          distance, kcal, bpm, oxygen);
  update_check_756_2_dial(ui_home, second, minute, hour, mode, am, day, month,
                          year, weekday, temp, icon, battery, connection, steps,
                          distance, kcal, bpm, oxygen);
  update_check_b_w_resized(ui_home, second, minute, hour, mode, am, day, month,
                           year, weekday, temp, icon, battery, connection,
                           steps, distance, kcal, bpm, oxygen);
  update_check_kenya(ui_home, second, minute, hour, mode, am, day, month, year,
                     weekday, temp, icon, battery, connection, steps, distance,
                     kcal, bpm, oxygen);
  update_check_pixel_resized(ui_home, second, minute, hour, mode, am, day,
                             month, year, weekday, temp, icon, battery,
                             connection, steps, distance, kcal, bpm, oxygen);
  update_check_radar(ui_home, second, minute, hour, mode, am, day, month, year,
                     weekday, temp, icon, battery, connection, steps, distance,
                     kcal, bpm, oxygen);
  update_check_smart_resized(ui_home, second, minute, hour, mode, am, day,
                             month, year, weekday, temp, icon, battery,
                             connection, steps, distance, kcal, bpm, oxygen);
  update_check_tix_resized(ui_home, second, minute, hour, mode, am, day, month,
                           year, weekday, temp, icon, battery, connection,
                           steps, distance, kcal, bpm, oxygen);
  update_check_wfb_resized(ui_home, second, minute, hour, mode, am, day, month,
                           year, weekday, temp, icon, battery, connection,
                           steps, distance, kcal, bpm, oxygen);

  update_check_174(ui_home, second, minute, hour, mode, am, day, month, year,
                   weekday, temp, icon, battery, connection, steps, distance,
                   kcal, bpm, oxygen);
  update_check_228(ui_home, second, minute, hour, mode, am, day, month, year,
                   weekday, temp, icon, battery, connection, steps, distance,
                   kcal, bpm, oxygen);
  update_check_1041(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
  update_check_1167(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
  update_check_1169(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
  update_check_2051(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
  update_check_2151(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
  update_check_3589(ui_home, second, minute, hour, mode, am, day, month, year,
                    weekday, temp, icon, battery, connection, steps, distance,
                    kcal, bpm, oxygen);
}
...
void ui_games_init(void) {
  ...
  if (numGames == 0) {
    ...
    lv_obj_set_height(info, LV_SIZE_CONTENT); /// 1
    lv_obj_set_align(info, LV_ALIGN_CENTER);
    lv_label_set_text(info, "No games available currently. Check whether it "
                            "was enabled in the code");
  }
}

void ui_games_update(void) { ui_raceScreen_screen_loop(); }
...
void ui_errorWindow_init(void) {
  ...
  lv_obj_set_flex_align(ui_errorPanel, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  lv_obj_clear_flag(ui_errorPanel, LV_OBJ_FLAG_SCROLLABLE); /// Flags
  lv_obj_set_style_bg_color(ui_errorPanel, lv_color_hex(0x080404),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(ui_errorPanel, 235, LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_errorPanel, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_errorPanel, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_errorPanel, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(ui_errorPanel, 8,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(ui_errorTitle, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(ui_errorTitle, &lv_font_montserrat_16,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_color(ui_errorTitle, lv_color_hex(0xFFFFFF),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_opa(ui_errorTitle, 255,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(ui_errorTitle, 1,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_side(ui_errorTitle, LV_BORDER_SIDE_BOTTOM,
                               LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_pad_bottom(ui_errorTitle, 5,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_errorMessage, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(ui_errorCloseText, &lv_font_montserrat_14,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
...
void init_custom_face() {
  ...
  lv_obj_set_style_bg_color(face_custom_root, lv_color_hex(0x000000),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(face_custom_root, 255,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_border_width(face_custom_root, 0,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_left(face_custom_root, 0,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_right(face_custom_root, 0,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_top(face_custom_root, 0,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_pad_bottom(face_custom_root, 0,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
